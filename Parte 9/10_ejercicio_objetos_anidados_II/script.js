...
let user_surname = prompt("Insert Surname:");
let user_date = prompt("Insert Date:");


let code_name = user_name.charAt(0);
let code_surname =user_surname.charAt(user_surname.length-1);
let code_date = user_date.charAt(user_surname.length-1);
/*
console.log( " " + code_surname + " " + code_date);


console.log(user_name.charAt(0));
console.log(user_surname.charAt(user_surname.length-1));
console.log(user_date.charAt(user_surname.length-1));
*/
console.log (letraNombre[code_name.charAt(0)].masculino + " " + letraApellido[code_surname.charAt(0)].masculino + " " + fechaNacimiento[code_date].masculino);
